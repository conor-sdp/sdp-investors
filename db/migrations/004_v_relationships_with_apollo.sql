-- Migration 004: extend v_relationships with Apollo-sourced fields.
-- Prefer Apollo description over scraped og:description when both present.
...
SELECT
  ...
  f.aum_usd_m,
  f.fund_size_usd_m,
  -- Strategy/description: prefer Apollo (richer), fall back to scraped og:description
...
INSERT OR IGNORE INTO schema_migrations(version) VALUES ('004_v_relationships_with_apollo');
