...
SHEETS = [
    ("Relationships",
     """SELECT firm, firm_type, apollo_industry, apollo_employee_count,
               apollo_founded_year, apollo_annual_revenue,
               ...
               hq_city, hq_country, apollo_hq_city, apollo_hq_state, apollo_hq_country,
               domain, url, firm_linkedin, firm_twitter, firm_phone,
               ...
               apollo_enriched_at, relationship_id, firm_id, contact_id
